...
def build_parser() -> argparse.ArgumentParser:
    ...
    review.add_argument("action", nargs="?", choices=("recover-infrastructure", "authorize-retry"))
    ...
    review.add_argument("--phase", help="Exact active phase for historical infrastructure recovery")
    review.add_argument("--review-ref", help="Canonical .cw/reviews reference")
    review.add_argument("--expected-review-sha256", help="Exact selected review SHA-256")
    review.add_argument("--expected-workflow-sha256", help="Exact workflow CAS")
    review.add_argument("--expected-state-sha256", help="Exact state CAS")
    review.add_argument("--reason", help="Mandatory auditable recovery reason")
    review.add_argument("--dry-run", action="store_true", help="Preview recovery without writes")
    review.add_argument("--apply", action="store_true", help="Apply the exact governed recovery")
    review.add_argument("--acknowledge-unverifiable-legacy", action="store_true", help="Acknowledge unverifiable legacy review")
