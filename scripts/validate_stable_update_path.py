...
assert str(parsed.version) == "0.15.1"
...
assert str(info.installed) == "0.14.1" and str(info.latest) == "0.15.1"
assert installed is not None and installed.current == "0.15.1"
candidate = paths.versions / "0.15.1"
...
_, reinstalled = service.install(requested_version="0.15.1")
assert reinstalled is not None and reinstalled.current == "0.15.1"
...
print(json.dumps({
    ...
    "update": "0.14.1 -> 0.15.1", "rollback": "0.15.1 -> 0.14.1",
    "reupdate": "0.14.1 -> 0.15.1", "build_commit": build["commit"],
