...
assert str(info.installed) == "0.14.1" and str(info.latest) == "0.15.0"
assert installed is not None and installed.current == "0.15.0"
candidate = paths.versions / "0.15.0"
...
_, reinstalled = service.install(requested_version="0.15.0")
assert reinstalled is not None and reinstalled.current == "0.15.0"
...
print(json.dumps({
    ...
    "update": "0.14.1 -> 0.15.0", "rollback": "0.15.0 -> 0.14.1",
    "reupdate": "0.14.1 -> 0.15.0", "build_commit": build["commit"],
